...
In addition, we also provide SDKs for the C and C++ API, which you can download from here，[Download C API Edition](https://im.sdk.qcloud.com/download/plus/9.0.7652/cross_platform/ImSDK_iOS_C_9.0.7652.framework.zip), [Download  C++ API Edition](https://im.sdk.qcloud.com/download/plus/9.0.7652/cross_platform/ImSDK_iOS_CPP_9.0.7652.framework.zip).
