...
<table >
  ...
  <tr >
     ...
     <td style="text-align:center"><a href="https://im.sdk.qcloud.com/download/plus/9.0.7652/ImSDK_Plus_9.0.7652.framework.zip">ImSDK_Plus.framework</a></td>
  </tr>
    
  <tr >
     <td style="text-align:center">XCFramework 版本</td>
     <td style="text-align:center">支持 Objective-C API 和 Mac catalyst</td>
     <td style="text-align:center"><a href="https://im.sdk.qcloud.com/download/plus/9.0.7652/ImSDK_Plus_9.0.7652.xcframework.zip">ImSDK_Plus.xcframework</a></td>
  </tr>

  <tr >
     <td style="text-align:center">Apple Vision Pro 版本</td>
     <td style="text-align:center">支持 visionOS 并提供 Swift API</td>
     <td style="text-align:center"><a href="https://im.sdk.qcloud.com/download/plus/9.0.7652/ImSDKForVision_Plus_9.0.7652.xcframework.zip">ImSDKForVision_Plus.xcframework</a></td>
  </tr>
</table>
...
<table >
  ...
  <tr >
     ...
     <td style="text-align:center"><a href="https://im.sdk.qcloud.com/download/plus/9.0.7652/TIMQuicPlugin_9.0.7652.framework.zip">TIMQuicPlugin.framework</a></td>
  </tr>
</table>
...
此外，我们还提供了 C 接口和 C++ 接口的 SDK，您可以从这里下载：[下载 C API 版本](https://im.sdk.qcloud.com/download/plus/9.0.7652/cross_platform/ImSDK_iOS_C_9.0.7652.framework.zip)、[下载 C++ API 版本](https://im.sdk.qcloud.com/download/plus/9.0.7652/cross_platform/ImSDK_iOS_CPP_9.0.7652.framework.zip)。
